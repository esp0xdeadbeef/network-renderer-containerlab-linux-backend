...
grep -F 'would ensure Docker tooling image cache, cleanup fabric, materialize bridges, deploy, rematerialize bridges, materialize lab emulation, retry WAN DHCP, reconcile access advertisements, and verify containers' \
